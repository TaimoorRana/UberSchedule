...
ActiveRecord::Schema.define(version: 20150311225215) do
  ...
  create_table "tbl_prereq_type", primary_key: "prereq_type_id", force: :cascade do |t|
    t.string "prereq_type_lib", limit: 128, null: false
  end

  create_table "tbl_schedule", primary_key: "schedule_id", force: :cascade do |t|
  ...
  add_foreign_key "tbl_lookup_course_prerequisites", "tbl_prereq_type", column: "prereq_type_id", primary_key: "prereq_type_id", name: "tbl_lookup_course_prerequisites_ibfk_3"
  add_foreign_key "tbl_lookup_course_registered", "tbl_course", column: "course_id", primary_key: "course_id", name: "tbl_lookup_course_registered_ibfk_1"
  add_foreign_key "tbl_lookup_course_registered", "tbl_schedule", column: "schedule_id", primary_key: "schedule_id", name: "tbl_lookup_course_registered_ibfk_2"
  add_foreign_key "tbl_lookup_course_registered", "tbl_student", column: "student_id", primary_key: "student_id", name: "tbl_lookup_course_registered_ibfk_3"
